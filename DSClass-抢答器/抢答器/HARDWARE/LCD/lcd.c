...
void LCD_Show_CH_Font32(u16 x,u16 y,u8 index,u8 showstring[])
{      
    u8 temp,t,t1;
    u16 y0=y;
...
void LCD_Show_Ch_Font64(u16 x,u16 y,u8 index,u8 showstring[]){
	u16 temp,t,t1;
    u16 y0=y;
...
void LCD_Show_Ch_Font96(u16 x,u16 y,u8 index,u8 showstring[]){
	u16 temp,t,t1;
    u16 y0=y;
  
    for(t=0;t<1152;t++) //=24*24   72??
    {   
       temp=showstring[index*1152+t]; 
       for(t1=0;t1<8;t1++)
       {
				  if(temp&0x80)LCD_Fast_DrawPoint(x,y,POINT_COLOR);
			    else LCD_Fast_DrawPoint(x,y,BACK_COLOR);  
